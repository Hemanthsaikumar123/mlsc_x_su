        ...
        <div className="grid gap-12 md:grid-cols-[0.55fr_1.45fr] md:gap-20">
          ...
          >
            <div className="flex items-center gap-3">
              <span className="h-px w-8 bg-[#59C4F7]" />

              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#59C4F7]">
                What is MLSC × SU ?
              </p>
            </div>
          ...
          >
            <h2 className="max-w-4xl text-4xl font-bold leading-[0.98] tracking-[-0.045em] text-white md:text-6xl">
              A place to{" "}
              <span className="text-[#59C4F7]">learn,</span>
              <br />
              experiment and build.
            </h2>

            <p className="mt-7 max-w-2xl text-sm leading-7 text-white/75 md:text-base">
              MLSC × SU brings students together to explore technology,
              learn from one another, build real projects and create
              experiences that extend beyond the classroom.
            </p>

            <Link
              href="/about"
              className="group mt-8 inline-flex items-center gap-3 border-b border-[#59C4F7]/30 pb-2 text-[10px] font-black uppercase tracking-[0.18em] text-white/55 transition-colors hover:border-[#59C4F7] hover:text-[#59C4F7]"
            >
              Discover MLSC
          ...
          <div className="grid grid-cols-2 md:grid-cols-4">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <p className="mt-2 text-[9px] font-bold uppercase tracking-[0.22em] text-[#59C4F7]/55">
                  {stat.label}
                </p>
              </div>
            ))}
